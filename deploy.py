...
class Deploy(object):
    def __init__(self, filename="./4000_checkpoint.tar", k=6):
        # set the random seed
        self.SEED = 15
    ...
    def setup_model(self):
        ...
        self.encoder.eval()
        self.decoder.eval()
        # a.save("scripted_chatbot.pth")
        print('Models built and ready to go!')
        # self.encoder.pickle("encoder.pth")
        # self.decoder.save("decoder.tar")
        ...
        # self.searcher.save("searcher.tar")
